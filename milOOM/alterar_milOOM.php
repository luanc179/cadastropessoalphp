...
<body>
	...
	<form method="POST" action="">
		...
		<label for="nome2">Nome completo:</label><br>
		<input type="text" name="nome2" value="<?php echo $dado['nome2'] ?>"><br>
		...
		<input type="time" name="entrada2" value="<?php echo $dado['entrada'] ?>"><br>
		<label for="saida">Saida:</label><br>
		<input type="time" name="saida2" value="<?php echo $dado['saida'] ?>"><br>
		...
		<input type="text" name="post2" value="<?php echo $dado['post'] ?>"><br>
		<label for="nomeguerra">Nome de Guerra:</label><br>
		<input type="text" name="nomeguerra2" value="<?php echo $dado['nomeguerra'] ?>"><br>
		<label for="destino">Destino:</label><br>
		<input type="text" name="destino2" value="<?php echo $dado['destino'] ?>"><br>		
		<input type="submit" value="Salvar">
	</form>
	<br>
	<form action="./cadastro_milOOM.php">
